...
# C:\Users\User\AppData\Local\Programs\Python\Python311\Python.exe C:\Users\User\AppData\Local\Programs\Python\Python311\Python.exe D:\soft\Visualchatgpt\TaskMatrix-main\visual_chatgpt.py --load "Text2Box_cuda:0,Segmenting_cuda:0,Inpainting_cuda:0,ImageCaptioning_cuda:0
# C:\Users\User\AppData\Local\Programs\Python\Python311\Scripts\pip.exe install cv2
# C:\Users\User\AppData\Local\Programs\Python\Python311\Python.exe D:\soft\Visualchatgpt\TaskMatrix-main\visual_chatgpt.py
# Grounding DINO
...
class InstructPix2Pix:
    def __init__(self, device):
        ...
        self.device = device
        self.torch_dtype = torch.float32 if 'cuda' in device else torch.float32
...
class Inpainting:
    def __init__(self, device):
        ...
        self.torch_dtype = torch.float32 if 'cuda' in self.device else torch.float32
...
class ConversationBot:
    def __init__(self, load_dict):
        ...
        #dataloader = torch.utils.data.DataLoader(self, batch_size=8)
